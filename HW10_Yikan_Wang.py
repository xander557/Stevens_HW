...
Author: Yikan
I stored the data as dictionaries and list
as I thought it would be more concise.
After the completion, I found by doing so it is very
difficult to handle the edge case that
student from the students.txt file who has no grades yet.
However I do handle other edge cases that input file contains
contaminated input.
I will change the way it stores data for the next submission
"""
